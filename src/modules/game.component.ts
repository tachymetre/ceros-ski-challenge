...
(() => {
  ...
  do {
    ...
    prompt("Please provide skier's initial direction: (1 = left, 2 = leftDown, 3 = center, 4 = rightDown, 5 = right)"),
        userInputSpeed =
    prompt("Please provide skier's speed: (4-12) with 4 = slow, 8 = medium, 12 = fast");
